...
(define-public monero-p2pool
  (let ((commit "1c33cc9f3dfde26c28ccd50e30617652bd42a35a")
        (revision "1"))
    (package
      (name "p2pool-xmr")
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "19pn7axj96yvza2x7678rs79c2vgmhl8d7f9ki72v2n6l2630fw8"))))
...
(define-public xmrig
  (let ((commit "834ea445072e50ffc385d7b88ee395c1e8ce957f")
        (revision "1"))
    (package
      (name "xmrig")
      (version (git-version "6.18.0" revision commit))
      (source (origin
                ...
                (sha256
                 (base32
                  "1ncnfjpjwjdv29plyiam2nh01bfni49sgfi3qkijygi1450w71dx"))))
      (build-system cmake-build-system)
      (outputs '("out"))
      (arguments
       `(#:tests? #false
