...
(define-public rust-assert-cmd-2
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0l81a5i09h4ibm4nabm7d9k3k4iqgs54za90wjgi3lgqxn1vdml6"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-winnow-0.4
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0j4lyck3m17ir6ylbm17bnv7xf1ygqv6spipy04n5ngh8lwcw2na"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-anstyle" ,rust-anstyle-0.3)
...
(define-public rust-toml-edit-0.19
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "19rl9q65nxynn56mxjncky5j0gb3dcaydpw03a5fr7h3gxmh2vr6"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-time-macros-0.2
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "16yh6g3k9rcksa94jyakvwkp6vcy7hldf4g2vcwby1sz1aa50a9p"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-time-0.3
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1z8y87bxq0fr23r1ma7kb1a15ws2spa8ah77v42y0fi4y4y1p7pa"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-sysinfo-0.29
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "15c6ld3fa53pj7sbcdyrkz6vckr143qxy43v5wcaivl6bf2d0mwm"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-starship-battery-0.8
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0yzq4hyzr8nhxx5ln42i1rdvxz9cn3mq9pgrxgqk3l7asvb3pfnd"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-cfg-if" ,rust-cfg-if-1)
...
(define-public rust-serde-derive-1
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0s0xccdxvz8ilr4jqqgw8iqkfnvjx6i90kciys5w4lfciiimnwyr"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-proc-macro2" ,rust-proc-macro2-1)
...
(define-public rust-serde-1
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0z82r42ayqb48vw4cbsja4byl779vh33p4k4q6dpd3z973wqr34y"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-ratatui-0.21
  (package
    (name "rust-ratatui")
    (version "0.21.0")
    (source (origin
              ...
              (sha256
               (base32
                "0khpqxvjs5nqg6w0fld1akhsisxd6gg8w5j06wn43hp7hq21x16f"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-bitflags" ,rust-bitflags-1)
...
(define-public rust-nvml-wrapper-sys-0.7
  (package
...
(define-public rust-nvml-wrapper-0.9
  (package
...
(define-public rust-clap-complete-4
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "12rq9q0ynp8g2n64m9l4pcj5c9049c3kv4m78ccacgmbkd8mqsvz"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-clap" ,rust-clap-4)
...
(define-public rust-tempfile-3
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1mm6n3ijfsnk7grbbws3fc9qy4y5n3pshixa19wmhzimfqj47h1i"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-autocfg" ,rust-autocfg-1)
...
(define-public rust-clap-builder-4
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1h51pqlfqmf58bi8v5q0zaacisdg1c7ip8k5dwymvhsbpf44m6rc"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-anstream" ,rust-anstream-0.3)
...
(define-public rust-clap-4
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0zfvhzgx3hfnvl5vm8ly5hy6n97bqc0l538fv4dv97s8wh3pm9xv"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-bottom-0.9
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0r06ad5wax0391nyn4f71h02ynrnlcfwc6lqfd46dfy3qmvgdy0i"))))
    (build-system cargo-build-system)
    ...
    (arguments
     `(#:cargo-inputs (("rust-anyhow" ,rust-anyhow-1)
                       ...
                       ("rust-clap-mangen" ,rust-clap-mangen-0.2) ;; TODO NEED
                       ("rust-concat-string" ,rust-concat-string-1) ;; TODO NEED
                       ("rust-core-foundation" ,rust-core-foundation-0.9)
                       ("rust-crossterm" ,rust-crossterm-0.26)
                       ("rust-ctrlc" ,rust-ctrlc-3)
                       ("rust-dirs" ,rust-dirs-5)
                       ("rust-fern" ,rust-fern-0.6)
                       ("rust-filedescriptor" ,rust-filedescriptor-0.8) ;; TODO NEED
                       ("rust-hashbrown" ,rust-hashbrown-0.14)
                       ...
                       ("rust-libc" ,rust-libc-0.2)
                       ("rust-log" ,rust-log-0.4)
                       ("rust-mach2" ,rust-mach2-0.4);; TODO need
                       ("rust-nvml-wrapper" ,rust-nvml-wrapper-0.9);; TODO need
                       ("rust-once-cell" ,rust-once-cell-1)
                       ("rust-ratatui" ,rust-ratatui-0.21);; TODO need
                       ("rust-regex" ,rust-regex-1)
                       ("rust-rustix" ,rust-rustix-0.37)
                       ("rust-serde" ,rust-serde-1)
                       ("rust-serde-json" ,rust-serde-json-1)
                       ("rust-starship-battery" ,rust-starship-battery-0.8);; TODO need
                       ("rust-sysctl" ,rust-sysctl-0.5)
                       ("rust-sysinfo" ,rust-sysinfo-0.29)
                       ("rust-thiserror" ,rust-thiserror-1)
                       ("rust-time" ,rust-time-0.3)
                       ("rust-toml-edit" ,rust-toml-edit-0.19)
                       ("rust-unicode-segmentation" ,rust-unicode-segmentation-1) ;; TODO need
                       ("rust-unicode-width" ,rust-unicode-width-0.1)
