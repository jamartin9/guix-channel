...
(define-public %jam-netbook
  (operating-system
    ...
    (swap-devices (list (swap-space
                          (target (uuid "a82191d1-c19b-43b3-a4b0-c7d50ca08f58")))))

    (file-systems (cons* (file-system
                           (mount-point "/boot/efi")
                           (device (uuid "F904-5CD0"
                                         'fat32)) ;blkid output
                           (type "vfat"))
                         (file-system
                           (mount-point "/")
                           (device (uuid
                                    "c25ef7d9-95bf-4c80-94a2-8e569b71985a"
                                    'ext4))
                                          ...
                                          (guix-configuration (inherit config)
                                                              ...
                                                              (substitute-urls
                                                               (append (list
                                                                        ...
                                                                        "https://cuirass.genenetwork.org/") ;4zwzi66wwdaalbhgnix55ea3ab4pvvw66ll2ow53kjub6se4q2bclcyd.onion
