...
(define %jam-home
  ...
  alias guixPackVm=\"guix system image -t qcow2\" # qemu-img resize x.qcow +10G boot then growpart and resize2fs. qcow2-gpt with grub-efi-removable-bootloader on /efi and -bios /usr/share/ovmf/x64/OVMF.4m.fd
  _guix_run_vm(){
      local vmOpts=()
      local qOpts=()
      local target=\"\"
